    ...
    <x-filament::section class="overflow-x-auto">
        @if (empty($data))
            <div class="p-4 text-center text-gray-500">
                Tidak ada program untuk tahun yang aktif
            </div>
        @else
            <div class="mb-4">
                        ...
                        @foreach ($programs as $p)
                            ...
                            <tr class="group hover:bg-gray-50 transition-colors">
                                ...
                                <td style="width: 250px !important;"
                                    class="border p-2 align-top break-words whitespace-normal"
                                    title="{{ $p->title }}">
                                    {{ $p->title }}
                                </td>
                                        ...
                                        <td class="border p-1 relative group/cell">
                                            @if ($isFilled)
                                                <div style=
                                                    ...
                                                    @endif
                                                    class="{{ $programColor }} h-6 rounded 
                                                ...
                                                @if ($isStart)
                                                    <div
                                                        class="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-1 hidden group-hover/cell:block z-30">
                                                        <div
                                                ...
                                                @if ($isEnd)
                                                    <div
                                                        class="absolute top-full left-1/2 transform -translate-x-1/2 mt-1 hidden group-hover/cell:block z-30">
                                                        <div
                                                            class="bg-black text-white text-xs rounded py-1 px-2 whitespace-nowrap">
                                                            End: {{ $name }} {{ $weekLabel }}
                                                        </div>
